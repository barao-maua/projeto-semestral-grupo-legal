    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='paginas.professional')),
            ],
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='paginas.patient')),
                ('professional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='paginas.professional')),
            ],
        ),
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='paginas.user'),
        ),
        migrations.AddField(
            model_name='patient',
            name='user',
